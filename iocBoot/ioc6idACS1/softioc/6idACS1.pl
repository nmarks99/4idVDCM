...
BEGIN
{
	...
	#! $ENV{IOC_BINARY}="6idACS1";
	
	
	# Top-level bin directory for the IOC
	$ENV{IOC_BIN_DIR}="$ENV{TOP}/bin";
	#! $ENV{IOC_BIN_DIR}="/home/username/epics/synApps/support/6idACS1/bin";
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/6idACS1/iocBoot/ioc6idACS1";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/6idACS1/iocBoot/ioc6idACS1/softioc/commands";
