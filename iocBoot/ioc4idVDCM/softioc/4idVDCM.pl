...
BEGIN
{
	...
	#! $ENV{IOC_BINARY}="4idVDCM";
	
	
	# Top-level bin directory for the IOC
	$ENV{IOC_BIN_DIR}="$ENV{TOP}/bin";
	#! $ENV{IOC_BIN_DIR}="/home/username/epics/synApps/support/4idVDCM/bin";
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/4idVDCM/iocBoot/ioc4idVDCM";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/4idVDCM/iocBoot/ioc4idVDCM/softioc/commands";
