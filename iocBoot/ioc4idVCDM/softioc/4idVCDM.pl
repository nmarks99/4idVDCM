...
BEGIN
{
	...
	#! $ENV{IOC_BINARY}="4idVCDM";
	
	
	# Top-level bin directory for the IOC
	$ENV{IOC_BIN_DIR}="$ENV{TOP}/bin";
	#! $ENV{IOC_BIN_DIR}="/home/username/epics/synApps/support/4idVCDM/bin";
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/4idVCDM/iocBoot/ioc4idVCDM";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/4idVCDM/iocBoot/ioc4idVCDM/softioc/commands";
